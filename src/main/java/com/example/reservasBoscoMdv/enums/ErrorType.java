...
public enum ErrorType {
    ...
    RESERVA_NO_ENCONTRADA("RESERVA_NO_ENCONTRADA", "Reserva no encontrada."),
    JSON_PARSE_ERROR("JSON_PARSE_ERROR", "Error al analizar el JSON de entrada."),
    RESERVA_TRAMO_DIA_INCORRECTO("RESERVA_TRAMO_DIA_INCORRECTO", "El tramo horario no coincide con el día de la reserva."),
